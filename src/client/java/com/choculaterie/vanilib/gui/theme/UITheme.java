package com.choculaterie.vanilib.gui.theme;
...
public final class UITheme {
	...
	public static final class Colors {
		...
		public static final int ACCENT_GREEN_HOVER = 0xFF5FBF63;
		public static final int ACCENT_GREEN_DARK  = 0xFF1B5E20;
		...
		public static final int SELECTION_HIGHLIGHT  = 0x804CAF50;
		...
		public static final int TOAST_BG_SUCCESS     = ACCENT_GREEN_DARK;
		...
		public static final int TOAST_ACCENT_SUCCESS = ACCENT_GREEN;
		...
		public static final int TOGGLE_ON        = ACCENT_GREEN;
		public static final int TOGGLE_ON_HOVER  = ACCENT_GREEN_HOVER;
		public static final int TOGGLE_OFF_HOVER = 0xFF5A5A5A;

		public static final int ERROR_TEXT = 0xFFFF5555;
		public static final int SUCCESS_BG = ACCENT_GREEN;
